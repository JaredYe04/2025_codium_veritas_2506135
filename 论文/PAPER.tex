...
We analyzed the gender ratio in the Olympics, focusing on two aspects: the male-to-female ratio of athletes participating in the Games and the male-to-female ratio of medal winners, as shown in the figure.
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=14cm]{img/Gender with Award.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=14cm]{img/Gender.png}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{.32\textwidth}
		...
		\caption{Bronze SHAP Summary Ploty}\label{subfig:3}
	\end{subfigure}
...
\begin{itemize}
		\item Task1
 We performed data preprocessing and feature engineering on the provided dataset, using the KMeans++ clustering algorithm to determine the ranking of each country. We calculated various feature variables, including each country's proficiency in different sports, the host nation advantage, and the performance level of different athletes.

 \qquad Ultimately, we used the LightGBM gradient boosting regression algorithm to predict the expected medal count for each athlete from each country participating in the 2028 Olympics. By aggregating these predictions, we obtained the total medal count for each country.

\qquad The model indicates that the United States is expected to show progress, while France will experience a significant decline, likely due to the home-field advantage of the host nation. Additionally, due to annual fluctuations in events, countries like Australia and Japan are expected to see an increase in their medal count, while Italy and South Korea will experience a decrease. China's medal count is projected to remain stable.

\qquad For countries that have never won a medal, we analyzed past events in which these countries participated but did not secure any medals. If future events are expected to expand the number of available medals, we reason that these countries may have a higher probability of winning their first medal in 2028. Through quantitative analysis, we identified Sierra Leone, Antigua and Barbuda, and Papua New Guinea as the countries with the highest likelihood of winning their first medal in 2028.

\qquad For events where certain countries have clear advantages, we performed a correlation analysis across countries at different levels and calculated the Spearman correlation coefficient between changes in total medal count and medal distribution, as well as changes in the medal structure for those events. We found that for countries with strong overall events adeptness, such as China, the influence of dominant events on their total ranking and medal count is minimal, resulting in relatively stable performances. However, for smaller countries, their dependence on dominant events is stronger, and their total medal count largely depends on performance in these key events.
	
	

	\item Task2
	To explore the "great coach" effect, we used the Bayesian Changepoint Detection model to analyze the impact of Lang Ping on the Chinese and U.S. women's volleyball teams, Béla Károlyi on the U.S. and Romanian women's gymnastics teams, and other similar examples. By comparing the historical coaching tenure of a coach with the predicted changepoints identified by the model, we found a strong correlation between the changepoints in a country's sports performance and the tenure of a great coach, indicating the significant impact of such coaches.\\
	
	\qquad 	After establishing the importance of hiring coaches, we selected three representative countries from the level 1 to level 3 countries and applied the CUSUM algorithm to assess their weakest events.

	\qquad We found that sailing was once a strong event for France in early Olympics, with stable results from 1930 to 1970, but a significant decline after the 1970s. Sweden dominated athletics and shooting from the 1920s to the 1950s, but these events declined over time, likely due to a decrease in the country's emphasis on sports. German swimming, which was not dominant before the 1990s, emerged as a strong contender in the early 21st century, but showed signs of decline in the 2010s and 2020s. Based on these findings, we recommend that these countries hire coaches to maintain their competitive edge.

	\item Task3 
	Using the models and data derived from Task 1 and Task 2, we conducted in-depth data mining and analysis, leading to several key conclusions about the Olympics, including athlete gender ratio, the dominance of certain countries in specific Olympic events, and how changes in medal distribution reflect global geopolitical shifts.
	
	\qquad Regarding the athlete gender ratio, we found that in the earliest Olympic Games, male athletes and their proportion of total medals dominated. However, as gender equality awareness grew, more women began participating in the Olympics, leading to a significant yearly increase in the number of female athletes and a more balanced gender ratio.
	
	\qquad In terms of the dominance of certain countries in specific Olympic events, we observed that some niche events, unique to particular countries, tend to be dominated by these countries. For example, the UK has a dominant position in cricket and motorboating, while Canada excels in lacrosse. Thus, national Olympic committees seeking to win more medals should consider investing in these distinctive events, expand their influence, and lobby the International Olympic Committee to include these events in the Olympic program, strengthening their competitive advantage.
	
	\qquad Moreover, by examining the changes in medal distribution across countries over time, we identified several distinct anomalies, occurring in 1904, 1980, 1984, and 1992. These anomalies reflect the evolution of the Olympics from its infancy to maturity, and also highlight the intense geopolitical rivalry during the Cold War. From the changes in medal counts across countries, we can gain indirect insights into global political and economic developments.
